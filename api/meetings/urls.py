...
urlpatterns = [
    ...
    path('get-password/', views.GetMeetingPasswordView.as_view()),
    path('images/get/', views.GetRoomImagesView.as_view()),
    path('data/get/<slug:token>/', views.GetMeetingDataView.as_view()),
    path('rooms/get/<slug:token1>/<slug:token2>/', views.GetRoomDataView.as_view()),
